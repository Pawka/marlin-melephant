...
#define STRING_VERSION "1.0.3 pwk-3"
...
// E3D V6
    #define  DEFAULT_Kp 23.08
    #define  DEFAULT_Ki 2.35
    #define  DEFAULT_Kd 56.71
...
//from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define  DEFAULT_bedKp 416.53
    #define  DEFAULT_bedKi 62.31
    #define  DEFAULT_bedKd 696.07
...
#define Z_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -0.8 // -below (always!)
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {87.489,87.489,3200/3,92.65}  // default steps per unit for Ultimaker
